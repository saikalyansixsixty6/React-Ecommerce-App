...
const SingleProductCard = ({item})=>{
    const {images,title,rating,price} = item;
    ...
    return (
      ...
      <div>
                            <a className="block relative h-48 rounded overflow-hidden">
                                <img className="object-cover object-center w-full rounded-2xl h-full block hover:scale-110 transition-scale-110  duration-300 ease-in-out" src={images[0]}/>
                            </a>
                            <div className="mt-4">
